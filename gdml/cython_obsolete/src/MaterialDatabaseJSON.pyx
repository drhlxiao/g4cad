...
class MaterialDatabase(object):
    ...
    def edit(self):
        ...
        if 'linux2' == sys.platform:
            subprocess.call(["xdg-open", self._databaseFilename])
        else:
            ...
            if e['name']==name:
                for c in e['compositions']:
                    ...
                    if c['frac']>=2:
                        #components
                        frac_type=1
                    matlist.append([name,frac_type, c['ref'], c['frac'],0, e['density']])
        return matlist
    ...
    def getJSONMaterial(self, namelist):
        jlist=[]
...
if __name__=="__main__":
    ...
    matlist=["HPM1801","BKG7G18",
            ...
            "Ti6Al4V","F2G12",
            "Alu5A06","PMMA"]
    print json.dumps(db.getJSONMaterial(matlist))
    db.edit()
